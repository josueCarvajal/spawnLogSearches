How to use the script
    ...
    This script requires 5 arguments to run
        ...
        Example: ./spawnSearchesV1.sh 1000000 100 true 600000 15.214.135.144

CAVEAT: you must run this script in the machine where you want to send the events, (it will be part of the improvement to run everywhere)